...
\ExperienceEntry{PRODYNA SE}{2025-present}{IT Consultant}{
    \begin{itemize}[itemsep=0pt, topsep=1pt, leftmargin=1.2em]
        \item Consulting on cloud-native infrastructure, Kubernetes, and DevOps practices.
        \item Designing and implementing monitoring solutions for distributed systems.
        \item Supporting clients in adopting modern infrastructure and observability tooling.
    \end{itemize}
}
\sepspace
\ExperienceEntry{Dear Reality GmbH}{2022-2025}{C/C++ Backend Software Developer}{
    \begin{itemize}[itemsep=0pt, topsep=1pt, leftmargin=1.2em]
...
%%% ------------------------------------------------------------
\NewPart{Education}{}
\ExperienceEntry{M.Sc. Media Computer Science}{2018-2020}{University of Applied Sciences, Düsseldorf}{
    \begin{itemize}[leftmargin=1.2em, label={}]
...
\sepspace
\ExperienceEntry{Guest Semester: M.Sc. Music Computer Science}{2018}{University of Music, Karlsruhe}{
    \begin{itemize}[leftmargin=1.2em, label={}]
        \item Focus on machine learning and music information retrieval.
    \end{itemize}
}
\sepspace
...
\SkillsEntry{Technologies}{}{}{
    6 years: \\
        \textsc{C++17}, C99, Boost, CMake, Python, gtest/gmock, Azure DevOps, Git, Docker, JUCE, nvim/vim \\
        \\
    3 years: \\
        conan, Pure Data (Pd), Azure-DevOps, flask, Jenkins, Linux \\
        \\
    1 year: \\
        MATLAB, Github Actions, \LaTeX, Unreal Engine, Unity, Kubernetes, Terraform/Terragrunt, Microsoft Azure, Cloud-Architecture \\
        \\
}

\SkillsEntry{Other}{}{}{
    6 years: \\
        agile workflows, Scrum/Kanban, Jira, Confluence, quality assurance\\
}
...
\ExperienceEntry{Microsoft Certified: Azure Developer Associate (AZ-204)}{2025}{Microsoft}{
    \begin{itemize}[leftmargin=1.2em, label={}]
        \item Certified in developing cloud solutions on Microsoft Azure.
    \end{itemize}
}
\sepspace
\ExperienceEntry{GitHub Certified: GitHub Copilot}{2025}{GitHub}{
    \begin{itemize}[leftmargin=1.2em, label={}]
        \item Certified in using GitHub Copilot for AI-assisted software development.
    \end{itemize}
}
