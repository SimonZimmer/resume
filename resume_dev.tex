...
% Use minipage to align image and personal details side by side
\noindent
\begin{minipage}[t]{3cm} % Adjust width to match the image width
    \includegraphics[height=4cm, valign=t]{images/portrait} % Adjust height as needed
\end{minipage}%
\hspace{1em} % Add some horizontal space between image and text
\begin{minipage}[t]{0.7\textwidth} % Adjust width as needed
    \MyName{Simon Zimmermann} % Use \MyName for the name
    \MySlogan{Software Developer} % Use \MySlogan for the slogan
    \sepspace
    \sepspace
    \sepspace
...
\sepspace
\SkillsEntry{Technologies}{}{}{\textsc{C++17}, C99, boost, CMake, conan, Python, googletest/googlemock, google benchmark, Pure Data (Pd), Azure DevOps, Github Actions, Jenkins, git, docker, JUCE, pybind11, flask, wagtail, MATLAB, JUCE, \LaTeX, Linux, nvim/vim}
\sepspace
\SkillsEntry{Other}{}{}{Music Production, Modular Synthesizer, Esoteric Programming Lanuages (Orca, TidalCylces)}
